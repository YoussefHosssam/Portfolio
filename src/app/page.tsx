  ...
  return (
    <>
      <main className="min-h-screen">
        ...
        <section id="home" className="py-20 px-6 flex items-center justify-center min-h-screen">
        ...
        {/* 🔹 2. About Me */}
        <section id="about" className="py-20 px-6 bg-gradient-to-br from-white/50 to-blue-50/50 dark:from-slate-900/50 dark:to-slate-800/50">
              ...
              {projects.map((project, index) => (
                ...
                >
                  ...
                  <div className="flex-1 w-full max-w-lg">
                    ...
                    >
                      {project.photo ? (
                        <div className="w-full h-80 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                          <img
                            src={project.photo}
                          ...
                          />
                          <div className="hidden w-full h-full bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    {category.items.map((skill, skillIndex) => (
                      <motion.div
                        ...
                        className="group flex flex-col items-center p-4 rounded-xl bg-white/60 dark:bg-slate-800/60 hover:bg-white/80 dark:hover:bg-slate-700/80 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 dark:hover:shadow-blue-400/20 border border-white/20 dark:border-slate-700/50 hover:border-blue-300/50 dark:hover:border-blue-500/50"
                      >
                        <div className="w-12 h-12 mb-3 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-200">
                          {skill.icon}
                        </div>
                        <span className="text-sm font-medium text-slate-700 dark:text-slate-300 text-center group-hover:text-slate-900 dark:group-hover:text-slate-100 transition-colors">
                          {skill.name}
                        </span>
                      </motion.div>
                    ))}
            ...
            <div className="mt-16">
              ...
              >
                ...
                <div className="relative pl-20">
                  ...
                  {/* Content Card */}
                  <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl p-8 border border-white/20 dark:border-slate-700/50 hover:shadow-xl transition-all duration-300">
                    <div className="space-y-6">
                      {/* Header */}
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <span className="text-sm text-slate-500 dark:text-slate-400 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/40 dark:to-purple-900/40 px-4 py-2 rounded-full font-medium">
                      ...
                      {/* Highlights */}
                      <div className="space-y-3">
                        <h5 className="text-sm font-semibold text-slate-700 dark:text-slate-200 uppercase tracking-wider">
                          Key Achievements
                        </h5>
                      ...
                      <div className="pt-4 border-t border-slate-200/50 dark:border-slate-700/50">
                        <div className="inline-flex items-center space-x-3 px-4 py-3 bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 rounded-lg">
                          <div className="w-8 h-8 rounded-lg overflow-hidden bg-white p-1">
                            ...
                            />
                            <div className="hidden w-full h-full flex items-center justify-center text-lg">
                              🏢
                            </div>
                          </div>
